...
for(n in 1: length(h)) {
  ...
  ## save out
  save(all_data, file=paste("ignore/Probs/F5_", NodeName, "_Steelhead_depth_Migration_discharge_probs_2010_2017_TS_updated_hyd.RData", sep=""))
  ...
  write.csv(Q_Calc, paste("ignore/Probs/F5_",NodeName,"_Steelhead_Migration_depth_Q_calculation_updated_hyd.csv", sep=""))
  ...
  write.csv(limits, paste("ignore/Probs/F5_",NodeName,"_Steelhead_Migration_depth_Q_limits_updated_hyd.csv", sep=""))
  ...
  write.csv(melt_time, paste("ignore/Probs/F5_", NodeName, "_Steelhead_Migration_depth_time_stats_updated_hyd.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("ignore/Probs/F5_", NodeName, "_Steelhead_Migration_depth_total_days_long_updated_hyd.csv", sep="") )
...
for(n in 1: length(h)) {
  ...
  ## save out
  save(all_data, file=paste("ignore/Probs/F5_", NodeName, "_Steelhead_velocity_Migration_discharge_probs_2010_2017_TS_updated_hyd.RData", sep=""))
...
plot(new_data$Q, new_data$value)
  ...
  write.csv(Q_Calc, paste("ignore/Probs/F5_",NodeName,"_Steelhead_Migration_velocity_Q_calculation_updated_hyd.csv", sep=""))
  ...
  write.csv(limits, paste("ignore/Probs/F5_",NodeName,"_Steelhead_Migration_velocity_Q_limits_updated_hyd.csv", sep=""))
  ...
  write.csv(melt_time, paste("ignore/Probs/F5_", NodeName, "_Steelhead_Migration_velocity_time_stats_updated_hyd.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("ignore/Probs/F5_", NodeName, "_Steelhead_Migration_velocity_total_days_long_updated_hyd.csv", sep="") )
...
for(n in 1: length(h)) {
  ...
  ## save out
  save(all_data, file=paste("ignore/Probs/F5_", NodeName, "_Steelhead_depth_Smolts_discharge_probs_2010_2017_TS_updated_hyd_prolonged.RData", sep=""))
  ...
  write.csv(Q_Calc, paste("ignore/Probs/F5_",NodeName,"_Steelhead_Smolts_depth_Q_calculation_updated_hyd.csv", sep=""))
  ...
  write.csv(limits, paste("ignore/Probs/F5_",NodeName,"_Steelhead_Smolts_depth_Q_limits_updated_hyd_prolonged.csv", sep=""))
  ...
  write.csv(melt_time, paste("ignore/Probs/F5_", NodeName, "_Steelhead_Smolts_depth_time_stats_updated_hyd_prolonged.csv", sep=""))
  ...
  ## save df
  write.csv(melt_days, paste("ignore/Probs/F5_", NodeName, "_Steelhead_Smolts_depth_total_days_long_updated_prolonged_hyd.csv", sep="") )
