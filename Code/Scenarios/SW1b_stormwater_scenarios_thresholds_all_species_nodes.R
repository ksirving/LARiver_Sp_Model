...
setwd("/Users/katieirving/SCCWRP/LA River Eflows Study - General/Data/RawData/Results_Hydraulics/Stormwater_Scenarios/results-hydraulics_postprocessed")
dir <- "/Users/katieirving/SCCWRP/LA River Eflows Study - General/Data/RawData/Results_Hydraulics/Stormwater_Scenarios/results-hydraulics_postprocessed/"

h <- list.files(pattern="predictions")
length(h) ## 18
h
h <- h[-c(7,11)] ## remove LA1/ LA2
...
for(n in 1: length(h)) {
  ...
  write.csv(prob_statsx, paste("results/scenarios/probs/SW1b",NodeName, "all_species_thresholds_stormwater_scenarios_probs.csv", sep="_"))
