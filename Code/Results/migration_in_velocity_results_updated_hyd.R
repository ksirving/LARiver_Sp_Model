...
write.csv(time_stats_all, "results/Steelhead_Migration_Velocity_time_stats_updated_hyd.csv")
...
write.csv(total_days_all,"results/Steelhead_Migration_Velocity_total_days_updated_hyd.csv")
