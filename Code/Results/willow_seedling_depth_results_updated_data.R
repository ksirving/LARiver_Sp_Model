...
write.csv(time_stats_all, "results/Willow_Seedling_Depth_time_stats_updated_hyd.csv")
...
write.csv(total_days_all,"results/Willow_Seedling_Depth_total_days_updated_hyd.csv")
